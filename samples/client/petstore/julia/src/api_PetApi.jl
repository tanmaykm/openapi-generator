...
function _oacinternal_addPet(_api::PetApi, in_Pet; _mediaType=nothing)
    _ctx = OpenAPIClient.Ctx(_api.client, "POST", Pet, "/pet", ["petstore_auth", ], in_Pet)
...
function addPet(_api::PetApi, response_stream::Channel, in_Pet; _mediaType=nothing)
    _ctx = _oacinternal_addPet(_api, in_Pet; _mediaType=_mediaType)
...
function _oacinternal_updatePet(_api::PetApi, in_Pet; _mediaType=nothing)
    _ctx = OpenAPIClient.Ctx(_api.client, "PUT", Pet, "/pet", ["petstore_auth", ], in_Pet)
    OpenAPIClient.set_header_accept(_ctx, ["application/xml", "application/json", ])
    OpenAPIClient.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "application/xml", ] : [_mediaType])
    return _ctx
end
...
function updatePet(_api::PetApi, response_stream::Channel, in_Pet; _mediaType=nothing)
    _ctx = _oacinternal_updatePet(_api, in_Pet; _mediaType=_mediaType)
    OpenAPIClient.exec(_ctx, response_stream)
end
